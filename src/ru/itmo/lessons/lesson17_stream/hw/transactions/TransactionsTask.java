package ru.itmo.lessons.lesson17_stream.hw.transactions;
    ...
    public static void main(String[] args) {
        ...
        Map<String, Long> map = transactionStream
                .collect(Collectors.toMap( //Hach -map
                        transaction -> transaction.getAccount().getNumber(), //ключи elem -> elem
                        Transaction::getSum, // значение
                        (elem1, elem2) -> elem1 + elem2 // как формировать значения,
        ...
        transactionStream = Stream.of(transaction1, transaction2, transaction3,
                transaction4, transaction5, transaction6, transaction7);
        System.out.println((Long) transactionStream.mapToLong(Transaction::getSum).sum());
